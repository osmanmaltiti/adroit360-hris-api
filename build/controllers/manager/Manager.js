...
const getManager = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (currentUser) {
            const verifyPassword = (0, Encyption_1.comparePassword)(password, String(currentUser.password));
            if (verifyPassword) {
